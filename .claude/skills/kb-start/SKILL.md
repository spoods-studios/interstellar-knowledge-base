...
- **Manually** when the user types `/kb-start`.
...
```
## Resume briefing — Expert-reviewed educational content - equations, articles, and translations.
